...
class since04 extends source {
    ...
    createObject() {
        ...
        this.lopCanhNen.addChild(this.nen);
        ...
        this.bando_chantroi = new PIXI.Sprite(PIXI.Texture.WHITE);
        this.bando_chantroi.name = "Lớp màu chân trời";
        this.bando_chantroi.tint = 0x49b45b;

        this.bando_channuixa = new PIXI.Sprite(PIXI.Texture.WHITE);
        this.bando_channuixa.name = "Lớp màu núi xa";
        this.bando_channuixa.tint = 0x49b45b;
        ...
        this.nennhanvat = new PIXI.Container();
        this.nennhanvat.name = "Lớp nền nhân vật";

        this.nguoichoi = new PIXI.Container();
        this.nguoichoi.name = "Lớp nhân vật trên bản đồ";
        this.nguoichoi.zIndex = 2;
        ...
        this.lopCanhNen.addChild(this.bando_chantroi);
        this.lopCanhNen.addChild(this.bando_channuixa);


        this.lopCanhNen.addChild(this.bando_bautroi);

        this.lopCanhNen.addChild(this.bando_nuixanua);



        this.lopCanhNen.addChild(this.bando_nuixa);



        this.lopCanhNen.addChild(this.bando_nuida);
        this.container.addChild(this.bando);

        this.bando_hieuung = new PIXI.Container();
        this.bando_hieuung.name = "Lớp hiệu ứng bản đồ";
        this.container.addChild(this.bando_hieuung);

        this.container.addChild(this.nennhanvat); // người chơi khác trên bản đồ
        ...
        this.bando_suongmu = new PIXI.Container();
        this.bando_suongmu.name = "Lớp sương mù";
        // zindex 1
        this.bando_suongmu.zIndex = 1;
        this.container.addChild(this.bando_suongmu);
        ...
        this.postionChar.position.set(0, this.gameHeight *0.5);
        ...
        let donDanh2 = this.showFPS;
        donDanh2.style.stroke = "#000000";
        donDanh2.style.strokeThickness = 4;
        ...
        this.NutOnScreenAction = new PIXI.Container();
        this.NutOnScreenAction.name = "Các lớp nút trên màn hình thực hiện";
        this.NutDaChet = new PIXI.Container();
        this.NutDaChet.name = "Các lớp nút đã chết";
        this.NutDaChet.visible = false;
        this.inGame.addChild(this.NutOnScreenAction,this.NutOnScreen,this.NutDaChet);
        ...
        this.chipiBox.name = "Lớp thông báo chim chipi";
        this.screen.addChild(this.chipiBox);
    ...
    fps() {
        ...
        return this.app.ticker.FPS <= 70 ? 1 : Math.round(this.app.ticker.FPS / 60) * 2;

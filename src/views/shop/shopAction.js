import vutItemAction from '../menu/vutItemAction.js';

export default class shopAction extends vutItemAction {
    constructor() {
        super();
    }
    ...
    comfirmSell = (idbag) => {
        ...
        if(!dataShop) return this.chipi(this._('Vật phẩm này không thể bán.'));

        if(ruong.active != "hanhtrang") return this.chipi(this._('Vui lòng tháo vật phẩm ra hàng trang trước.'));

        if(dataShop.sell == -1) return this.chipi(this._('Vật phẩm này không thể bán.'));

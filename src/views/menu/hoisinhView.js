import coPKView from "./coPKView.js";



export default class hoiSinhView extends coPKView {
    constructor() {
        super();
    }
    ...
    boxMenuHoiSinh = () =>{
        ...
        nen.y = this.gameHeight - nen.height ;

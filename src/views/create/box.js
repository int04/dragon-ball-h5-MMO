import detuView from '../detu/detuView.js';
class Box extends detuView {
    constructor() {
        super();
        this.lastmenuOpen = '';
        this.boxFirst = true;
    ...
    snowlySroll = (body, hienthinoidung) => {
        ...
        if(hienthinoidung.height < body.height) {
            let height = body.height - hienthinoidung.height;
            let background = new PIXI.Graphics();
            background.beginFill(0x000000, 0.00001);
            background.drawRect(0, 0, body.width, height);
            background.endFill();
            background.y = hienthinoidung.height;
        ...
        viewport.setZoom(1); // Thiết lập tỉ lệ thu phóng là 1

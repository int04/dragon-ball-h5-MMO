import ptWhereWho from './whereView.js';

export default class chatViewPT extends ptWhereWho {
    constructor() {
        super();
    }

    sendChatPT(txt, inputChat) {
    ...
    oepnChatPTView() {
        ...
        if(this.my.id <= 0 || this.my.skin.bangID <=0) return;
    ...
    chatCreatePT() {
        ...
        let displayChat = new PIXI.Text('Chat bang:', {
            fontSize: 20,
            fill: 0x005325,
            fontFamily: 'chelthm',
            fontWeight: 'bold',
        ...
        btnOK.on('pointerdown', () => {
            this.sendChatPT(inputChat.text)

import previewChatPT from './previewChat.js';

export default class menberPTGuestView extends previewChatPT {
    constructor() {
        super();
    }
    /**
     * @module
     * @desc : Xem thành viên bang hội khác
     */


    viewMenberGuest = (bang) => {
        ...
        let txt = this.html(`<font color="532905">Thành viên: `+bang.name+`</font>`);
        ...
        bang.menber.forEach((element,i) => {
            ...
            background.on('pointerup', () => {
                let time2 =  Date.now();
                if(time2 - time < 200) return this.previewMenberPTGuest(background,element);  
            });

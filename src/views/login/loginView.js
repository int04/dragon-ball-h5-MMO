import activeAccountView from './activeAccount.js';

class loginView extends activeAccountView {
    constructor() {
        super();
    ...
    pageLogin() {
        ...
        buttonRegister.on('pointerdown', () => {
            ...
            this.playSound('click');
            this.notice("Vui lòng vào trang chủ của trò chơi để quên mật khẩu.");
        });

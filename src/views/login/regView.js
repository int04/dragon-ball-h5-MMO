...
class regView extends guestView {
    constructor() {
        super();
    ...
    MenuCreateNewPlayer = () => {
        ...
        let skin_dau = [
            [],
            ["", "fghjfghjttttt", "sLeNYzwVYi", "sdfgsdfgrty55"], // gohan, kirin, yamcha
            ["", "XnPloWDTdg", "gNiPLfNjlC", "LivLKpGKlE"], // vegete, calic, kakarot
            ["","gBPszFjQfJ","DZJzuIdkku","XZzRFLjcjA"]
        ];
        ...
        let txt_huongdan = new PIXI.Text('Admin: Tạo nhân vật xong khi vào game sẽ có nút liên kết tài khoản tại Chức năng.', {
            fontSize: 16,
            fill: 0x570c22,
            fontFamily: 'fontchinh',
            wordWrap: true,
        ...
        khung3.addChild(txt_huongdan); // !2
        txt_huongdan.x = khung3.width / 2 - txt_huongdan.width / 2;
        txt_huongdan.y = khung3.height - txt_huongdan.height ;

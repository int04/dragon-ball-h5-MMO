import dauThanView from '../chucnang/useDauThanView.js';
class attackDetuView extends dauThanView {
    constructor() {
        super();
        ...
        if(this.mucTieuDeTu) {
            ...
            if(detu.info.trangthai == 'baove') {
                ...
                for(let i = 0; i < skill.length; i++) {
                    let e = skill[i];
                    let infoskill = this.skill_active.find(e2 => e2.id == e.id);

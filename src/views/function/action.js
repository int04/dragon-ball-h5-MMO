import attackView from '../attack/attackView.js';
class actionFunc extends attackView {
    ...
    deleteEff = function(id) {
        let index = this.dataSkill.findIndex(element => element.id === id);
        if(index != -1) {

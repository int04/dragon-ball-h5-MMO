import snowlyvnGiaoDich from "./boxGiaodich.js";
export default class snowlyvnBoxShop extends snowlyvnGiaoDich {
    constructor(){
        super();
    }
    ...
    boxBaseShop = () => {
        ...
        for (let i = 0; i < shopData.length ; i++) {
            ...
            if(!inItem) continue;
            if(inItem.type == 'item' && inItem.type2 == 'sachvo' && inItem.class != my.info.coban.type) continue;

import snowlyVNloadingGame from './pageLoadgame.js';
class SnowlyVnSicentWelcome extends snowlyVNloadingGame {
    constructor() {
        super();
    }
    ...
    CreateMainGuestGame = () => {
        ...
        let desc = new PIXI.Text('*:Trò chơi là đồ án của sinh viên CNTT trượt môn (nhưng nghiện game). Mã nguồn game và được chia sẻ công khai cho mọi người (Public, Open Source Client). Nạp thẻ có tác dụng duy trì dự án, không nhằm mục đích kinh doanh.', {
            fontFamily: 'Arial',
            fontSize: 15,
            fill: 0xFFFFFF,
            fontWeight: 'bold',
        ...
        setTimeout(() => {
           if (this.username != '') this.logInGame();
            //this.pageLogin();
            setTimeout(() => {
                //this.talkAction('shop_buma')
...
export default SnowlyVnSicentWelcome;
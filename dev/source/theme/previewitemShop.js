...
import snowlyvnNoticeShop from './noticeShop.js';

export default class snowlyVNPriviewItemShop extends snowlyvnNoticeShop {
    constructor() {
        super();
    }
    ...
    useBuy = (id) => {
        ...
        if(shop.buy*1 > this.my.tien[shop.type]*1)
        {
